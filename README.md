...
**[https://aicoachagents.onrender.com/](https://aicoachagents.onrender.com/)**

> **Mock data only.** The hosted version does not run Ollama — the agent pipeline and UI work, but AI responses use safe canned fallbacks. For real LLM output, run the project locally (below).
